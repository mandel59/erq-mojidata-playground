...
You can use it like this, but you can use the `jq` command to make the output a little easier to read.
...
Alternatively, you can add keys to the output.
